...
def get_related_news(last_gemini_response, last_user_query):
    ...
    summarize_news_prompt = "Using the user's original query and your initial response, analyze the provided news articles to identify real-world events, companies/technologies/products, or people that connect to the concept discussed. List 8-10 connections in a bullet point manner with a one-sentence-maximum explanation emphasizing how it relates to the user's question. If no relevant articles are available, mention that in a sentence, and instead reference real-world events, technologies, or people you know to illustrate the concept. But try to extract any information from the news first. Bold key words like company or product names to enhance user engagement. "
